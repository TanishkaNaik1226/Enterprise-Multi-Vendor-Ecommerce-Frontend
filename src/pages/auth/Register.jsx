...
export default function Register({ onNavigate, onRegisterSuccess, theme }) {
  ...
  const validateForm = () => {
    ...
    if (role === 'vendor' && (!shopName || !phone)) {
      setError('Please fill in all vendor profile details.');
      return false;
    }
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate API registration delay (1.5 seconds)
    setTimeout(() => {
      setIsLoading(false);
